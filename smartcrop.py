...
class SmartCrop(object):
    ...
    def analyse(
        ...
        output_image = self.detect_edge(cie_image, output_image)
        output_image = self.detect_skin(cie_image, image, output_image)
        output_image = self.detect_saturation(cie_image, image, output_image)
